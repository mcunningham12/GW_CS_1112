...
public class MazeMaker5 {
	...
	recursivelyFindPath (maze, start, end,level);
	...
	for (int i=0; i<validNeighbors.length; i++) {
            ...
            // Try neighbor i.
	    System.out.println((makeBlanks(level)) + "Level " + level + ": " + validNeighbors[i].toString());
	    ...
	    System.out.println((makeBlanks(level)) + "Level " + level+ " " +  validNeighbors[i].toString() + "failed");
